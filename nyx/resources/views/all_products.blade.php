        ...
        <div id="filterSidebar">
            ...
            <div class="filter-content">
                <form method="GET" action="{{ route('products.index') }}">
                    ...
                    <button type="submit" class="btn-apply-filter mb-2">
                        Apply Filters
                    </button>
                    <a href="{{ route('products.index') }}"
                       class="btn-clear-filters btn btn-outline-secondary">
                        Clear Filters
                    </a>
                </form>
            </div>
                    ...
                    <a href="{{ route('products.show', $product) }}"
                       class="product-container text-decoration-none text-dark">
                        <div class="image-wrapper">
                            @if ($first)
                                <img src="{{ asset('storage/'.$first) }}" class="img-front" alt="{{ $product->title }}">
                            @endif
                            @if ($second)
                                <img src="{{ asset('storage/'.$second) }}" class="img-back" alt="{{ $product->title }} view">
                            @endif
                        </div>
                        <div class="product-title">{{ Str::upper($product->title) }}</div>
